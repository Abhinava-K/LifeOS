...
| **2.2** | User Management & Settings (REQ-USER: Profile, GDPR) | Parth P | Aug 08 – Aug 15 | 🔄 In Process | • User Profile entity & Prisma schema models<br>• User preference settings & theme store<br>• GDPR data export and account deletion endpoints |
...
| **4.3** | Expense Engine & OCR (REQ-EXP) | Jahaan S | Sep 24 – Oct 03 | ✅ Coded | Receipt image OCR extraction, category ledger, spend analytics, NestJS `ExpensesModule` & `ExpenseScreen` |
...
| `REQ-USER` | User Management & GDPR | Phase 2 | 🔄 In Process | [`srs.tex`](file:///c:/Users/Abhinava/AntiGravity%20Studes/VIT%20SEM5/SWEproj/markdowns/srs.tex) Section 4.2 / [`Base.md`](file:///c:/Users/Abhinava/AntiGravity%20Studes/VIT%20SEM5/SWEproj/markdowns/Base.md) §Profile |
